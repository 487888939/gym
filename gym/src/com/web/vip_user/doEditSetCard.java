...
@WebServlet("/doEditSetCard")
public class doEditSetCard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        card_typeSQ.setCard_type(card_name,card_price,indate,discount,card_id);
        resp.sendRedirect("setCard");
    }
}
